  ...
  return (
    <div className="home-container">
      ...
      <section className="all-cars-with-filters">
        <h1 className="car-list-title">
          Best Rental Cars this side of the Mississippi
        </h1>
        {!dcars && (
          <h1>
            LOADING...
        ...
        {dcars && (
          <ul className="car-cards">
            {dcars
              .filter(
                (dcar) =>
                  dcar.make.includes(text) ||
                  dcar.make.toLowerCase().includes(text) ||
                  dcar.model.includes(text) ||
                  dcar.model.toLowerCase().includes(text) ||
                  dcar.year.toLowerCase().includes(text)
              )
              .map((dcar) => (
                <CarCard
                  key={dcar._id}
