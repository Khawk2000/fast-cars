...
function SingleCar() {
  ...
  const postCarBooking = async () => {
    const editCar = {
      id: id,
      booked: car.booked,
      firstDate: car.firstDate,
      lastDate: car.lastDate,
    };
    const response = await fetch(BASE + "/cars/" + id, {
      method: "PATCH",
  ...
  return (
    <div className="single-car-container">
      {!car && (
        <div className="no-car-found-container">
      ...
      {car && (
        <div className="single-car-pic-container">
      ...
      <div className="single-car-info-container">
        {car && (
          <div className="single-car-details-container">
            <div className="car-name-center">
              <h1 className="car-name">
                {car.year} {car.make} {car.model}{" "}
              </h1>
            </div>
            <h3 className="car-info">
              This brand new {car.make} just rolled into our lot with plenty of
              brand new features including:
            </h3>
            <div className="list-spacer">
              <ul className="car-features">
                <li className="car-feature">
            ...
            <div className="center-pricing">
              <h2 className="car-pricing">
                All for you to rent for the price of{" "}
                <span className="money">${car.price}</span>/day
              </h2>
            </div>
          </div>
        )}

        {car && car.booked === false && (
          <div className="calendar-container">
            <Booking getDates={getDates} />
          </div>
        )}
        {car && car.booked === true && (
          <h2 className="booked-car-text">
            Sorry this car is booked until {car.lastDate}
          </h2>
        )}
        {car && car.booked === false && (
